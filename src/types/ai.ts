...
export const PROVIDERS: Record<AIProviderType, ProviderInfo> = {
  ...
  ollama: {
    ...
    models: [
      { id: 'qwen2.5:7b', name: 'Qwen 2.5 7B (中文推荐)', provider: 'ollama', maxTokens: 32768, supports: ['chat'] },
      { id: 'qwen2.5:14b', name: 'Qwen 2.5 14B', provider: 'ollama', maxTokens: 32768, supports: ['chat'] },
      { id: 'llama3.1:8b', name: 'Llama 3.1 8B', provider: 'ollama', maxTokens: 131072, supports: ['chat'] },
      { id: 'mistral:7b', name: 'Mistral 7B', provider: 'ollama', maxTokens: 32768, supports: ['chat'] },
      { id: 'deepseek-r1:8b', name: 'DeepSeek R1 8B', provider: 'ollama', maxTokens: 64000, supports: ['chat'] },
      { id: 'phi3:mini', name: 'Phi-3 Mini (快速)', provider: 'ollama', maxTokens: 128000, supports: ['chat'] },
      { id: 'llava:7b', name: 'LLaVA 7B (视觉)', provider: 'ollama', maxTokens: 4096, supports: ['chat'] },
      { id: 'nomic-embed-text', name: 'Nomic Embed (嵌入)', provider: 'ollama', maxTokens: 8192, supports: ['embedding'] },
    ],
  },
};
